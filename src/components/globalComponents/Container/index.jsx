const Container = ({ children, style }) => {
    return (
        <>
            <div className={`group w-full h-full relative overflow-hidden rounded-3xl p-5 bg-white border border-green flex flex-col items-center justify-center gap-2 cursor-pointer hover:bg-darkGreen`}>
                {children}
