...
const Button = ({ link, onClick, children, style }) => {
    return (
        <>
            <Link href={link} onClick={onClick} className={'text-green text-nowrap flex min-w-24 bg-gradient-to-r from-darkGreen to-buttonOp px-5 sm:px-3 font-bold py-1 rounded-lg relative group overflow-hidden hover:text-white ' + style} >
